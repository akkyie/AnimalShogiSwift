...
final class MessageTests: XCTestCase {
    func testInitialization() {
        let testcases: [(String, Message, UInt)] = [
            ...
            ("+h*2b", .drop(kind: .hiyoko, to: [1, 1], isBlack: true), #line),
            ("-h*2b", .drop(kind: .hiyoko, to: [1, 1], isBlack: false), #line),
            ...
            ("+h*2b,OK", .dropped(kind: .hiyoko, to: [1, 1], isBlack: true), #line),
            ("-h*2b,OK", .dropped(kind: .hiyoko, to: [1, 1], isBlack: false), #line),
