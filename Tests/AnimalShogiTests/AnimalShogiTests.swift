...
final class AnimalShogiTests: XCTestCase {
    func testMessage() {
        let testcases: [(String, Message, UInt)] = [
            ...
            ("START", .start, #line),
            ("Game_ID:20180910-001", .gameID("20180910-001"), #line),
            ("+2c2b", .move(from: [1, 2], to: [1, 1], isBlack: true), #line),
            ("-2c2b", .move(from: [1, 2], to: [1, 1], isBlack: false), #line),
            ("+2c2b,OK", .moved(from: [1, 2], to: [1, 1], isBlack: true), #line),
            ("-2c2b,OK", .moved(from: [1, 2], to: [1, 1], isBlack: false), #line),
    ...
    func testState() {
        let testcases: [(State, Message, State, UInt)] = [
            ...
            (.started(id: "asdf", isBlack: true), .moved(from: [0, 0], to: [2, 3], isBlack: false),
             .moved(id: "asdf", isBlack: true, from: [0, 0], to: [2, 3]), #line),
            (.started(id: "zxcv", isBlack: true), .gameOver(isIllegal: true),
             .waitingResult(id: "zxcv", isBlack: true, isIllegal: true), #line),
            (.started(id: "asdf", isBlack: false), .gameOver(isIllegal: false),
    ...
    func testDescription() {
        let testcases: [(String, String, UInt)] = [
            ...
            (Position(x: 0, y: 0)!.debugDescription, "[0, 0]", #line),
            (Position(x: 2, y: 3)!.debugDescription, "[2, 3]", #line),
            ...
            (String(Message.move(from: [0, 1], to: [2, 3], isBlack: true)), "+1b3d", #line),
            (String(Message.move(from: [2, 3], to: [0, 1], isBlack: false)), "-3d1b", #line),
            (String(Message.moved(from: [0, 1], to: [2, 3], isBlack: true)), "+1b3d,OK", #line),
            (String(Message.moved(from: [2, 3], to: [0, 1], isBlack: false)), "-3d1b,OK", #line),
